...
export type TrainingBookReference = {
  id: string;
  title: string;
  author: string;
  imagePath: string;
...
export type BaseExercise = {
  ...
  hint?: string;
  explanation: string;
  sourceBook?: Omit<TrainingBookReference, "imagePath">;
};
...
export type OrderingExercise = BaseExercise & {
  type: "ordering";
...
export type ScenarioExercise = BaseExercise & {
  type: "scenario";
  context: string;
  options: ExerciseOption[];
  correctOptionId: string;
...
export type DecisionJustificationExercise = OpenExerciseBase & {
...
export type DecisionJustificationAnswer = {
  type: "decision_justification";
  optionId: string;
...
export type TrainingSession = {
  ...
  skills: string[];
  sourceBooks: TrainingBookReference[];
  exercises: Exercise[];
