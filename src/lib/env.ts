...
const serverEnvSchema = clientEnvSchema.extend({
  ...
  TRAINING_ANALYTICS_MIN_COHORT_SIZE: z.coerce
    .number()
    .int()
    .min(5)
    .default(10),
  TRAINING_ANALYTICS_RETENTION_DAYS: z.coerce
    .number()
    .int()
    .min(30)
    .max(1095)
  ...
  TRAINING_ROLEPLAY_FREE_MONTHLY_LIMIT: z.coerce
    .number()
    .int()
    .min(0)
    .max(0)
    .default(0),
  TRAINING_ROLEPLAY_PRO_MONTHLY_LIMIT: z.coerce
    .number()
    .int()
    .min(0)
    .max(100)
    .default(2),
  TRAINING_ROLEPLAY_UNLIMITED_DAILY_SAFETY_LIMIT: z.coerce
    .number()
    .int()
    .min(1)
    .max(500)
    .default(10),
  TRAINING_ROLEPLAY_MAX_TURNS_PER_SESSION: z.coerce
    .number()
    .int()
    .min(2)
    .max(100)
    .default(24),
  TRAINING_ROLEPLAY_MAX_DURATION_MINUTES: z.coerce
    .number()
    .int()
    .min(1)
    .max(120)
    .default(15),
  TRAINING_ROLEPLAY_MAX_CONCURRENT_SESSIONS: z.coerce
    .number()
    .int()
    .min(1)
    .max(5)
    .default(1),
  TRAINING_ROLEPLAY_RESUME_WINDOW_HOURS: z.coerce
    .number()
    .int()
    .min(1)
    .max(168)
    .default(24),
  TRAINING_ROLEPLAY_MESSAGE_MAX_CHARS: z.coerce
    .number()
    .int()
    .min(100)
    .max(4000)
    .default(1500),
  TRAINING_ROLEPLAY_CHARACTER_MAX_OUTPUT_TOKENS: z.coerce
    .number()
    .int()
    .min(100)
    .max(2000)
    .default(300),
  TRAINING_ROLEPLAY_EVALUATION_MAX_OUTPUT_TOKENS: z.coerce
    .number()
    .int()
    .min(300)
    .max(4000)
    .default(1200),
  TRAINING_ROLEPLAY_RATE_LIMIT_PER_MINUTE: z.coerce
    .number()
    .int()
    .min(1)
    .max(60)
  ...
  TRAINING_ROLEPLAY_TIMEOUT_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(60000)
    .default(20000),
  TRAINING_ROLEPLAY_MAX_RETRIES: z.coerce
    .number()
    .int()
    .min(0)
    .max(2)
  ...
  TRAINING_TAXONOMY_ENABLED: booleanStringSchema.default("true"),
  TRAINING_CATEGORIES_ENABLED: booleanStringSchema.default("true"),
  TRAINING_LEARNING_PATHS_ENABLED: booleanStringSchema.default("true"),
  TRAINING_VISUAL_ANALYSIS_ENABLED: booleanStringSchema.default("true"),
  TRAINING_MESSAGE_EXERCISES_ENABLED: booleanStringSchema.default("true"),
  TRAINING_COGNITIVE_LEVELS_ENABLED: booleanStringSchema.default("true"),
  TRAINING_TRAINING_MODES_ENABLED: booleanStringSchema.default("true"),
  TRAINING_TRAINING_SEARCH_ENABLED: booleanStringSchema.default("true"),
