...
import { QualityAlertService } from "@/lib/training/analytics-service";
...
export async function GET(request: NextRequest) {
  ...
  return jsonData(await new QualityAlertService(access.service).list(request.nextUrl.searchParams.get("status") ?? undefined));
}
