...
export function HomeView({ books }: HomeViewProps) {
  ...
  return (
    <main
      className="min-h-screen overflow-x-clip bg-[#03040b] pb-16 pl-0 text-text-primary transition-[padding] duration-300 ease-out sm:pl-[var(--dashboard-sidebar-offset,84px)]"
    >
