      ...
      <div>
        ...
        {resolvedData.pathPreviews.length ? (
          <section
            ...
            aria-labelledby="category-paths-title"
          >
            <div className="flex items-center justify-between gap-3">
              <div>
                <h2 className="text-xl font-black" id="category-paths-title">
                  Rutas relacionadas
                </h2>
                <p className="mt-1 text-sm text-slate-500">
                  Avanza por módulos conectados con esta categoría.
                </p>
              </div>
              <Link
            ...
            <div className="mt-4 grid gap-3 lg:grid-cols-2">
              {resolvedData.pathPreviews.map((path) => (
                <Link
